...
class TransactionAgents2:
    ...
    intrmy_agt1: Optional[BranchAndFinancialInstitutionIdentification4] = field(
        default=None,
        metadata={
            "name": "IntrmyAgt1",
            "type": "Element",
    ...
    intrmy_agt2: Optional[BranchAndFinancialInstitutionIdentification4] = field(
        default=None,
        metadata={
            "name": "IntrmyAgt2",
            "type": "Element",
    ...
    intrmy_agt3: Optional[BranchAndFinancialInstitutionIdentification4] = field(
        default=None,
        metadata={
            "name": "IntrmyAgt3",
            "type": "Element",
